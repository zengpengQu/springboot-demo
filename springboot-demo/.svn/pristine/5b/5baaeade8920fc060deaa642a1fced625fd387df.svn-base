    ...
    MobileArea.prototype = {
        ...
        finish: function(e) {
            ...
            if($("#person-type-select")){
                personType = $("#person-type-select").val();
            };
            associate = $("#associateValue").val();
            associateName = $("#associateDemo").val();
            $("#orgTitle").text(associateName);
            var statisticData={"personType":personType,"orgCode":associate,"orgName":associateName};
            if(pageIndex=='personTypeView'){
                selectPersonTypeData(associate);
            }
            if(pageIndex=='statisticChart'){
                $("#recent-tab > li").each(function () {
                    if($(this).attr("class")=="active"){
                        var idAtrr = $(this).attr("id");
                        switch (idAtrr){
                            case 'sex':showSexEchart(statisticData);
                                break;
                            case 'nation':showNationEchart(statisticData);
                                break;
                            case 'age':showAgeEchart(statisticData);
                                break;
                            case 'edu':showEduEchart(statisticData);
                                break;
                            case 'degree':showDegreeEchart(statisticData);
                                break;
                            case 'pro':showProEchart(statisticData);
                                break;
                            case 'tech':showTechEchart(statisticData);
                                break;
            ...
            if(pageIndex=='rosterListBox'){
                updatePersonData(associate);
            }
        },
        close: function(e) {
            e.preventDefault();
